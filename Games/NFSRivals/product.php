      ...
      <section class="index-banner">
        ...
        <div class="container-2">
          <div class="product-h1">
            <h1>Need For Speed Rivals Free Download</h1>
          </div>

          <p style="margin: 0 !important;">Need For Speed Rivals Free Download PC game setup direct link. It is racing
            game with latest model of cars and online multiplayer Feature.</p>
          <h2>Need For Speed Rivals Overview</h2>

          <p>Here we have a new NFS game by the franchise of EA sports, Need For Speed Rivals. A very interesting and
            exciting racing game. NFS rivals consists every element that a young gamer demands. Its interface is very
            good with mind boggling game menu. This game is equally sensational for kids and teens. Even a eight year
            old kid has no problem in this electrifying game.
          </p>
          <div class="product-img">
            <img src="nfs.jpg" alt="office" style="width: 50%; height: 100%;">
          </div>

          <p>In its gameplay it is breath taking as other NFS games are. You have different game modes in which you can
            play.NFS rivals contains two different careers one as a cop and other as a racer. As a street racer you have
            the opportunity to race with the other street racers and earn points and money “illegally”. You will come
            across the RCPD. and you have to drive away from them as soon as possible otherwise they will bust you and
            you will lose all you have grossed through racing.
            Upon this NFS rivals also has a new stylish social system “Alldrive” by which a player can be connected to
            his friends and can play with them.
          </p>
          <div class="product-img">
            <img src="nfs2.jpg" alt="cod" style="width: 60%; height: 90%;">
          </div>
          <h2>Features of Need For Speed Rival</h2>

          <ul>
            <li>Mind blowing racing game.</li>
            <li>Exceptional weather system.</li>
            <li>Featuring two careers as cop and as racer.</li>
            <li>Excellent detailed graphics.</li>
          </ul>
          <div class="product-img">
            <img src="nfs3.jpg" alt="cod" style="width: 60%; height: 90%;">
          </div>
          <h2>System Requirements of Need for Speed Rivals</h2>
          <p>
          <ul>
            <li>Operating System: Windows XP, Windows Vista/ Windows 7/ Windows 8 and 8.1</li>
            <li>CPU: Intel 2.4 GHz Core 2 Duo</li>
            <li>RAM: 4GB</li>
            <li>Hard disk : 15 GB</li>
          </ul>
          </p>
          <div class="product-img">
            <img src="nfs4.jpg" alt="office" style="width: 60%;height: 90%;">
          </div>
          <h2>Download from here:</h2>
          <div class="download-button-container">
            <a href="download.php?file=NFSRivals" target="_blank" <button> <input type="button" name="button"
