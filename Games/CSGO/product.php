      ...
      <section class="index-banner">
        ...
        <div class="container-2">
          <div class="product-h1">
            <h1>Counter Strike Global Offensive Repack Free Download</h1>
          </div>

          <p style="margin: 0 !important;">Counter Strike Global Offensive Repack Free Download PC Game setup in single
            direct link for Windows. It is an amazing action game.</p>
          <h2>Counter Strike Global Offensive Repack PC Game 2019 Overview</h2>

          <p>Counter-Strike: Global Offensive (CS: GO) expands upon the team-based action gameplay that it pioneered
            when it was launched 19 years ago.
            CS: GO features new maps, characters, weapons, and game modes, and delivers updated versions of the classic
            CS content (de_dust2, etc.).
            ...
            competitive gaming tournaments and selling over 25 million units worldwide across the franchise. CS: GO
            promises to expand on CS’ award-winning gameplay and deliver it to gamers on the PC as well as the next gen
            consoles and the Mac.”
          </p>
          <div class="product-img">
            <img src="csgo.jpg" alt="office" style="width: 50%; height: 100%;">
          </div>
          ...
          <div class="product-img">
            <img src="csgo2.jpg" alt="cod" style="width: 60%; height: 90%;">
          </div>
          <h2>Technical Specifications of This Release.</h2>

          <ul>
            <li>Game Version : Repack</li>
            <li>Interface Language: English</li>
            <li>Audio Language : English</li>
            <li>Game Download Size : 9.3 GB</li>
          </ul>
          <div class="product-img">
            <img src="csgo3.jpg" alt="cod" style="width: 60%; height: 90%;">
          </div>
          <h2>System Requirements of Counter Strike Global Offensive Repack</h2>
          <p>Before you start Counter Strike Global Offensive Repack Free Download make sure your PC meets minimum
            system requirements.</p>
          <ul>
            <li>OS: Windows®7/Vista/XP</li>
            <li>Processor: Intel® Core™ 2 Duo E6600 or AMD Phenom™ X3 8750 processor or better</li>
            <li>Memory:2GBRAM</li>
            <li>Graphics: Video card must be 256 MB or more and should be a DirectX 9-compatible with support for Pixel
              Shader 3.0</li>
            <li>Setup Size: 41.9GB</li>
            <li>Hard Disk Space: 50GB</li>
          </ul>
          <div class="product-img">
            <img src="csgo4.jpg" alt="office" style="width: 60%;height: 90%;">
          </div>
          <h2>Download from here:</h2>
          <div class="download-button-container">
            <a href="download.php?file=csgo" target="_blank" <button> <input type="button" name="button"
